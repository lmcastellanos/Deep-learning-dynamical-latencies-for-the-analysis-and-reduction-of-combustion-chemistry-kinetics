...
stop_early = tf.keras.callbacks.EarlyStopping(monitor='loss', patience=5, min_delta=1e-4)
    
models=tuner.search(training_fit_in, training_fit_out, epochs=150, validation_data=(validation_fit_in, validation_fit_out))
